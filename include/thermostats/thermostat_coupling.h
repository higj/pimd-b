...
class Coupling {
public:
    explicit Coupling(const std::shared_ptr<VecArray>& momenta);
...
public:
    explicit CartesianCoupling(const std::shared_ptr<VecArray>& momenta);
...
public:
    NormalModesCoupling(const std::shared_ptr<VecArray>& momenta, const std::shared_ptr<NormalModes>& normal_modes, int this_bead);
